...
function RowChoice(x) {
	...
	<title><?php echo htmlspecialchars('Таблица на Дядо Коледа')?></title>
</head>
<body onload = "showOpenMenuIcon()">
<a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" hreflang="bg" type="text/html" name = "Pozdrav" target="_self"><?php echo '<p class = "nightGhost">Здравей,' . ' ' . $_SESSION['SSName'] . '!</p>';?></a>
<span id = "OpenMenu" class="nightBlue" onclick="openMenu()"><?php echo htmlspecialchars('Меню');?></span>
<div id="menu">
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" target="_self" method="post" name="WSSmainForm" accept-charset="utf-8">
		<ul id="BB2" class = "BB2"> 
			<li><a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" hreflang="bg" type="text/html" target="_self">
				<button type="submit" id = "YourSecretSanta" class="nightBlue" name="YourSecretSanta" value="YourSecretSanta"><?php echo htmlspecialchars('Имам ли Secret Santa?');?></button>
			</a></li>
			<li id="CC1" onclick = "MenuShow2()">
			<a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" hreflang="bg" type="text/html" target="_self">
				<button type="submit" id = "ShowWishes" class="nightBlue" name="ShowWishes" value="ShowWishes" onclick="RestoreMenu('CC')" onmouseover = "FixMenu('CC')" onmouseleave = "RestoreMenu('CC')"><?php echo htmlspecialchars('Покажи желанията');?></button>	
			</a>
			<ul id="CC" onmouseover = "FixMenu('CC')" onmouseleave = "RestoreMenu('CC')" onclick="RestoreMenu('CC')">
				<li><a rel="nofollow" href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"  hreflang="bg" type="text/html" target="_self">
					<button class="nightBlue" type="submit" name="WriteWish" value="WriteWish"><?php echo htmlspecialchars('Запиши желание');?></button>
					</a></li>
				<li><a rel="nofollow" href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"  hreflang="bg" type="text/html" target="_self">
					<button class="nightBlue" type="submit" name="ChangeWish" value="ChangeWish"><?php echo htmlspecialchars('Промени желание');?></button>
					</a></li>
				<li><a rel="nofollow" href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"  hreflang="bg" type="text/html" target="_self">
					<button class="nightBlue" type="submit" name="ChangeAddress" value="ChangeAddress"><?php echo htmlspecialchars('Промени адрес');?></button>
				</a></li>
			</ul>
			</li> 
			<li><a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" hreflang="bg" type="text/html" target="_self">
				<button type="submit" id = "BSendInvitationForSSW" class="nightBlue" name="BSendInvitationForSSW" value="BSendInvitationForSSW"><?php echo htmlspecialchars('Изпрати покана');?></button>
			</a></li>
				...
				<a rel="nofollow" href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" hreflang="bg" type="text/html" target="_self">
					<button type="submit" id = "ChangeData" class="nightBlue" name="ChangeData" value="ChangeData" onmouseover = "FixMenu('BB')" onmouseleave = "RestoreMenu('BB')" onclick="RestoreMenu('BB')"><?php echo htmlspecialchars('Промяна на данни');?></button>
				</a>	
					<ul id="BB" onmouseover = "FixMenu('BB')" onmouseleave = "RestoreMenu('BB')" onclick="RestoreMenu('BB')">
						<li><a rel="nofollow" href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"  hreflang="bg" type="text/html" target="_self">
							<button type="submit" class="nightBlue" name="ChangeNickname" value="ChangeNickname"><?php echo htmlspecialchars('Промяна на име');?></button>
						</a></li>
						<li><a rel="nofollow" href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"  hreflang="bg" type="text/html" target="_self">
							<button type="submit" class="nightBlue" name="ChangePassword" value="ChangePassword"><?php echo htmlspecialchars('Промяна на парола');?></button>
						</a></li>
						<li><a rel="nofollow" href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"  hreflang="bg" type="text/html" target="_self">
							<button type="submit" class="nightBlue" name="ChangeNameAndPass" value="ChangeNameAndPass"><?php echo htmlspecialchars('Промяна на име и парола');?></button>
						</a></li>
						<li><a rel="nofollow" href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"  hreflang="bg" type="text/html" target="_self">
							<button type="submit" class="nightBlue" name="DelPersonData" value="DelPersonData"><?php echo htmlspecialchars('Изтриване на данни');?></button>
						</a></li>
					</ul> 
			</li>
			<li><a href="second2.php" hreflang="bg" type="text/html" target="_self">
				<button type="submit" id = "ExitSait" class="nightBlue" name="ExitSait" value="ExitSait"><?php echo htmlspecialchars('Излез');?></button>
			</a></li> 
		</ul>		 
	</form>
</div>	
...
try {
    ...
    echo "<button id='WSSDataOfChoice' class='nightBlue' type='submit' name='WSSDataOfChoice' value='WishesChoice' onclick='ShowDataOfChoice()'>Дата</button><br>
    <button id='WSSAddressOfShipping' class='nightBlue' type='submit' name='WSSAddressOfShipping' value='WishesChoice' onclick='ShowAddressOfShipping()'>Адрес</button><br>";
    echo '<p class="nightBluePr fromChoiceForm1">Това желание сте избрали на ' . $str4 . '.' . $str5 . '.' . $str6 . 'в ' . $str8 . '</p><br>';
    if ($WSSAddress == NULL || $WSSAddress == " ") {
        echo '<p class="nightBluePr fromChoiceForm2">Все още не е записан адрес, на който да се изпрати подаръка.</p></div>';
    } else {
        echo '<p class="nightBluePr fromChoiceForm2">Адреса, на който трябва да се изпрати подаръка е: <br>' .  $WSSAddress . '.' . '</p><br><!--<p class="nightBluePr fromChoiceForm2">Крайна дата за изпълнение на желанието е 25.12.2023 г. </p>--></div>';
		}
} catch (PDOException $e) {
...
try {
    ...
    $WSSAddress = $row2['WSS_Address'];
    echo "<button id='WSSDataOfChoice' class='nightBlue' type='submit' name='WSSDataOfChoice' value='WishesChoice' onclick='ShowDataOfChoice()'>Час</button><br>
        <button id='WSSAddressOfShipping' class='nightBlue' type='submit' name='WSSAddressOfShipping' value='WishesChoice' onclick='ShowAddressOfShipping()'>Адрес</button><br>";
    echo '<p class="nightBluePr">Това желание сте избрали в ' . $str8 . ' ч.'. '</p><br>';
    if ($WSSAddress == NULL || $WSSAddress == " ") {
        echo '<p class="nightBluePr">Все още не е записан адрес, на който да се изпрати подаръка.</p></div>';
    } else {
        echo '<p class="nightBluePr fromChoiceForm2">Адреса, на който трябва да се изпрати подаръка е: <br>' .  $WSSAddress . '.' . '</p></div>';
		}
} catch (PDOException $e) {
    echo 'Error: ' . $e->getMessage();
	}
...
try {
	$sql_10 = "UPDATE persons SET Wish_for = '' WHERE Wish_for = 'Вашето желание'";
	$sql_11 = "UPDATE persons SET Address = '' WHERE Address = 'Вашия адрес'";
...
if (isset($_POST['YourSecretSanta'])) {
    try {
        ...
        if ($stmt13->rowCount() > 0) {
            echo "<div class='divShowData' name='divYourSecretSanta'><br>" . "<p class = 'WhiteSnow'>Имате Secret Santa!</p>";
            ...
            if ($stmt14->rowCount() > 0) {
                while ($row = $stmt14->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<p id='AddressF' class = 'nightBluePr'>Адреса, който сте посочили за изпращане е: <br><br>" . $WSSAddress . " " . "</p></div>";
                }          
            } else {
                echo "<form action='WishesSecretSanta.php' target='_self' method='post' name='WSSAddressForm' accept-charset='utf-8'>
                        <p id='AddressW' class = 'nightBluePr'>Запишете адреса, на който да бъде доставен Вашия подарък.</p>
                        <input id='WSSAddress' type='text' name='WSSAddress' value=' '><br>
                        <button id='WSSAddressComfurm' class = 'nightBlue' type='submit' name='WSSAddressComfurm'>Изпрати</button><br>
                        </form><br></div>";
				}

        } else {
            echo "<div class='divShowData' name='divYourSecretSanta'><br><p class = 'WhiteSnow'>Нямате Secret Santa!</p></div>";
			}
        ...
        if ($stmt80->rowCount() > 0) {
			...
			echo "<br><p id = 'Ay' class = 'WhiteSnow'>Нямате записано желание!</p>";
			}
    } catch (PDOException $e) {
        echo 'Error: ' . $e->getMessage();
    }
...
if (isset($_POST['WSSAddressComfurm'])) {
    try {
        ...
        if ($stmt15->rowCount() > 0) {
            echo "<div class='divShowData' name='divYourSecretSanta2'><p class='nightBluePr'>Адреса за изпращане е записан.</p></div>";
        } else {
            echo "<div class='divShowData' name='divYourSecretSanta2'><p class='nightBluePr'>Извинете, ще отговорим по-късно.</p></div>"; 
        }
    } catch (PDOException $e) {
        echo 'Error: ' . $e->getMessage();
		}
...
if (isset($_POST['ShowWishes'])) {
    try {
        ...
        if ($stmt16->rowCount() > 0) {
            echo "<div class='divShowData' name='divWSSChoiceForm'><p class='nightBluePr'>Вие сте избрали да изпълните желание:</p>  
                    <table><tr>
                        <th>Номер</th>
                        <th>Желание</th>
                    </tr>";
            ...
            echo "<form id='WSSChoiceForm' action='WishesSecretSanta.php' target='_self' method='post' name='WSSChoiceForm' accept-charset='utf-8'>
                    <button type='submit' id='WishesChoiceSRW' class='nightBlue'  name='WishesChoiceSRW' value='WishesChoice' onclick='Click ()'>Оставащи желания</button><br>
                    <button type='submit' id='WishesChoiceSSSW' class='nightBlue'  name='WishesChoiceSSSW' value='WishesChoice' onclick='Click ()'>Желания със Secret Santa</button><br>
			...
			if ($stmt19->rowCount() > 0) {
				...
				echo "<p class='nightGhost'>Към момента няма възможност да си изберете! </p></div>";
				} 
			if ($stmt20->rowCount() > 0) {
				echo "<div class = 'divShowData' name='divWSSChoiceForm2'><p class='nightGhost'>Нямате избрано желание за изпълнение.<br> Може Вие да си изберете желание или да дадете власт на компютъра да избере.</p>";
				echo "<table><tr>
						<th>№</th>
						<th>Wish</th>
					</tr>";
				...
				echo "</table><form action='WishesSecretSanta.php' target='_self' method='post' name='WSSChoiceForm2' accept-charset='utf-8'>
						<button id='WishesComputerChoice' class='nightBlue' type='submit' name='WishesComputerChoice' value='WishesChoice' onclick='Click()'>Компютъра да избере</button><br>
						<button id='WishesChoiceB' class='nightBlue' type='submit' name='WishesChoiceB' value='WishesChoice' onclick='Click()'>Потвърди избор</button><br>    
...
if (isset($_POST['WishesChoiceSRW'])) {
    try {
        ...
        if ($stmt23->rowCount() > 0) {
            echo "<div class = 'divTablesInfinitive' name='divWSSRemainingWishesForm'><p class='nightBluePr'>Оставащи желания</p>
                    <table><tr>
                        <th>№</th>
                        <th>Желание</th>
                    </tr>";
            ...
            echo "</table><form action='WishesSecretSanta.php' target='_self' method='post' name='WSSRemainingWishesForm' accept-charset='utf-8'>
                <button type='submit' id='WishesChoiceShowPSW' class='nightBlue' name='WishesChoiceShowPSW' value='WishesChoice' onclick='Click ()'>Избрано желание</button><br> 
                <button  type='submit' id='WishesChoiceSSSW' class='nightBlue' name='WishesChoiceSSSW' value='WishesChoice' onclick='Click ()'>Желания със Secret Santa</button><br>
                </form></div><br>";
        } else {
            echo "<div class = 'divTablesInfinitive' name='divWSSRemainingWishesForm'><p class = 'nightGhost ZeroZapisa'>Има 0 записа.</p>";
			}
    } catch (PDOException $e) {
        echo 'Error: ' . $e->getMessage();
		}
...
if (isset($_POST['WishesChoiceSSSW'])) {
    try {
        ...
        if ($stmt24->rowCount() > 0) {
            echo "<div class = 'divTablesInfinitive' name='divWSSSecretSantaWishesForm'><p class='nightBluePr'>Желания със Secret Santa</p>
                    <table><tr>
                    <th>№</th>
                    <th>Желание</th>
                    <th>Secret Santa</th>
            ...
            echo "</table><form action='WishesSecretSanta.php' target='_self' method='post' name='WSSSecretSantaWishesForm' accept-charset='utf-8'>
                <button id='WishesChoiceShowPSW' class='nightBlue' type='submit' name='WishesChoiceShowPSW' value='WishesChoice' onclick='Click ()'>Избрано желание</button><br>
                <button id='WishesChoiceSRW' class='nightBlue' type='submit' name='WishesChoiceSRW' value='WishesChoice' onclick='Click ()'>Оставащи желания</button<br>    
                </form></div><br>";
        } else {
            echo htmlspecialchars('Има 0 записа');
        }
    } catch (PDOException $e) {
        echo 'Error: ' . $e->getMessage();
		}
    ...
    try {
        ...
        if ($stmt25->rowCount() > 0) {
            while ($row = $stmt25->fetch(PDO::FETCH_ASSOC)) {
                $PSWish2 = $row['ID'];
                echo "<div class='divTablesData' name='divWSSSelectedWishesForm'><p class='nightBluePr'>Избрано желание</p>
                    <table><tr>
                        <th>№</th>
                        <th>Желание</th>
                        <th>Дата</th>
            ...
            echo "<form action='WishesSecretSanta.php' target='_self' method='post' name='WSSSelectedWishesForm' accept-charset='utf-8'>
                <button id='WishesChoiceSRW' class='nightBlue' type='submit' name='WishesChoiceSRW' value='WishesChoice' onclick='Click ()'>Оставащи желания</button<br>        
                <button id='WishesChoiceSSSW' class='nightBlue' type='submit' name='WishesChoiceSSSW' value='WishesChoice' onclick='Click ()'>Желания със Secret Santa</button><br>
                </form></div><br>";  	
        } else {
            echo htmlspecialchars('няма записи в таблицата');
        }
    } catch (PDOException $e) {
        echo 'Error: ' . $e->getMessage();
		}
    ...
    try {
        ...
        if ($stmt26->rowCount() > 0) {
            ...
            while ($row = $stmt26->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo "<p class = 'nightGhost'>Вие избрахте " . $WishID . " " . "</p></div>";
            }
	...
	if ($stmt37->rowCount() > 0) {
		...
		if ($stmt38->rowCount() > 0) {
			...
			while ($row = $stmt38->fetch(PDO::FETCH_ASSOC)) {
				...
				echo "<p class='nightGhost'>Компютъра избра за вас № " . $WishID2 . "</p>";
			}
			$stmt38->execute(); 
			echo "<form action='WishesSecretSanta.php' target='_self' method='post' name='WSSConfirmForm' accept-charset='utf-8'>
                <button id='WishesChoiceB2' class='nightBlue' type='submit' name='WishesChoiceB2' value='WishesChoice'>Потвърди избор</button><br>
				</form></div><br>";
		} else {
			echo '';
			}
...
if (isset($_POST['WishesChoiceB2'])) {
    ...
    if ($stmt39->rowCount() > 0) {
        ...
        while ($row = $stmt39->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo '<p class="nightGhost">Вие избрахте  № ' . $WishID2 . ' </p></div>';
        }
    } else {
        echo ' ';
		}
	...
	try {
		...
		if ($stmt43->rowCount() > 0) {
                while ($row = $stmt43->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<div class = 'divChangingData'><p class = 'nightBluePr'>Вече имате записано желание: <br><br>" . $WriteNewWish . " " . "</p></div>";
					echo "";
                }          
            } else {		
		echo "<div class = 'divChangingData' name='divWSSAddWishForm'><p class='nightGhost'>Запишете вашето желание:</p>
				...
				<button class='nightBlue btnFine' type='submit' name='ChangeAddWishSP' value='ChangeAddWishSP'>Потвърди</button>	
			</form></div>";
			}
	} catch (PDOException $e) {
        echo 'Error: ' . $e->getMessage();
...
if (isset($_POST['ChangeAddWishSP'])) {
	try {
        ...
        if ($stmt44->rowCount() > 0) {
            echo "<p class = 'nightGhost Zapisi'>Вашето желание е записано!</p></div>";
        } else {
            echo "<p class='nightBluePr'>Извинете, ще отговорим по-късно.</p></div>";   
        }
    } catch (PDOException $e) {
        echo 'Error: ' . $e->getMessage();
		}
...
if (isset($_POST['ChangeWish'])) {
		...
		if ($stmt45->rowCount() > 0) {
			echo "<div class='divShowData' name='divWSSChangeWishForm'><br>" . "<p class = 'nightGhost Zapisi'>Не може да променяте желането си!<br><br>Имате Secret Santa.</p>";
		} else {
			echo "<div class = 'divChangingData' name='divWSSChangeWishForm'><p class='nightGhost'>Запишете вашeто ново желание:</p>
				...
				<button class='nightBlue btnFine' type='submit' name='ChangeWishP' value='ChangeWishP'>Потвърди</button>	
			</form></div>";
			}
}
...
if (isset($_POST['ChangeWishP'])) {
	try {
        ...
        if ($stmt46->rowCount() > 0) {
            echo "<p class = 'nightGhost Zapisi'>Вашето ново желание е записано!</p></div>";
        } else {
            echo "<p class='nightBluePr'>Извинете, ще отговорим по-късно.</p></div>";  
        }
    } catch (PDOException $e) {
...
if (isset($_POST['ChangeAddress'])) {
    echo "<div class = 'divChangingData' name='divWSSChangeAdresForm'><p class='nightGhost'>Запишете нов адрес:</p>
		<form action='WishesSecretSanta.php' target='_self' method='post' name='WSSChangeAdresForm' accept-charset='utf-8'>
            ...
            <button class='nightBlue btnFine' type='submit' name='ChangeAdresP' value='ChangeAdresP'>Потвърди</button>	
        </form></div>";
}
...
if (isset($_POST['ChangeAdresP'])) {
	try {
        ...
        if ($stmt47->rowCount() > 0) {
            echo "<p class = 'nightGhost Zapisi'>Вашият нов адрес е записан!</p></div>";
        } else {
            echo "<p class='nightBluePr'>Извинете, ще отговорим по-късно.</p></div>"; 
        }
    } catch (PDOException $e) {
...
echo "<form id = 'SendForm1' action='WishesSecretSanta.php' name='SendForm1' target='_self' method='post' accept-charset='utf-8'>
	...
	<label for = 'nameResieverID' form = 'SendForm1' class = 'SendForm1Labels' name='nameResieverlabel'>Име на получател:
	<input id = 'nameResieverID' class = 'SendForm1Inputs' type='text' name='nameResiever'>	 
	<label for = 'mailResieverID' form = 'SendForm1' class = 'SendForm1Labels' name='mailResieverlabel'>E-mail на получател:</label><br>
	<input id = 'mailResieverID' class = 'SendForm1Inputs' type='text' name='mailResiever'><br> 
	<label for = 'MesageInvitationForSSW' form = 'SendForm1' class = 'SendForm1Labels' name='MesageResieverlabel'>Съобщение:</label><br>
	<input id =  'SendForm1Inputs1' class = 'SendForm1Inputs' type='radio' name='SendForm1Inputs1' value = '0'><label form = 'SendForm1' class = 'SendForm1Labels' name='mesage1Resieverlabel' for = 'SendForm1Inputs1'>Вие сте поканен да посетите Secret Santa Websait</label><br>
	<input id =  'SendForm2Inputs2' class = 'SendForm1Inputs' type='radio' name='SendForm2Inputs2' value = '1'><label form = 'SendForm1' class = 'SendForm1Labels' name='mesage2Resieverlabel' for = 'SendForm2Inputs2'>Вие сте поканен да се регистрирате в Secret Santa Websait</label><br>
	...
	<button  id = 'SeeInvitationForSSW' class='nightBlue' type='submit' name='SeeInvitationForSSW' onclick = 'ShowSendForm ()' value='SeeInvitationForSSW'>Виж поканата</button><br>
	<button  id = 'SendInvitationForSSW'  class='nightBlue' type='submit' name='SendInvitationForSSW' value='SendInvitationForSSW'>Изпрати</button><br>
...
if (isset($_POST['SeeInvitationForSSW'])) {	
	...
	if(isset($_POST['SendForm1Inputs1'])){
		...
		$InvitationSubject = "Вие сте поканен да посетите Secret Santa Websait";
		...
		$InvitationSubject = "Вие сте поканен да се регистрирате в Secret Santa Websait";
	...
	echo "<form id = 'SendForm1' action='WishesSecretSanta.php' name='SendForm1' target='_self' method='post' accept-charset='utf-8'>
			<fieldset id = 'SendForm2F' form = 'SendForm1' name='SSI2'><legend>Secret Santa Покана</legend>
				<p id = 'DoSend'>Здравей, <br>" . $InvitationTo . "</p><br>
				<p id = 'Do2Send'>" . $InvitationSubject . "</p><br>
				<p id = 'Do3Send'>" . $commenttxt . "</p><br>
				<p id = 'Do4Send'>Пожелаваме Светли Празници!</p><br>
				<button  id = 'SeeInvitationForSSW' class='nightBlue' type='submit' name='SeeInvitationForSSW' onclick = 'ShowSendForm ()' value='SeeInvitationForSSW'>Виж поканата</button><br>
				<button  id = 'SendInvitationForSSW'  class='nightBlue' type='submit' name='SendInvitationForSSW' value='SendInvitationForSSW'>Изпрати</button><br>
				<button  id = 'ResetInvitationForSSW'  class='nightBlue type='reset'' name='ResetInvitationForSSW' value='ResetInvitationForSSW' onclick = 'ResetInvitationField ()'>Reset</button><br>
			</fieldset></form><br>";		
...
if (isset($_POST['SendInvitationForSSW'])) {
	try {
        ...
        echo "<p class='nightGhost'>Получи се грешка!</p>";
		}
} catch (PDOException $e) {
    echo 'Error: ' . $e->getMessage();
	}			
		...
		echo "<form id = 'SendForm1' action='WishesSecretSanta.php' name='SendForm1' target='_self' method='post' accept-charset='utf-8' enctype='text/plain'>
			<fieldset id = 'SendForm2F' form = 'SendForm1' name='SSI2'><legend>Secret Santa Покана</legend>
				<p id = 'Do4Send'>Поканата е изпратена!</p><br>
			</fieldset></form><br>";
		echo "<script> setInterval(RPerson,3000); </script>";
} catch (PDOException $e) {
        echo 'Error: ' . $e->getMessage();
    }
}
...
if (isset($_POST['ChangeNickname'])) {
    echo "<div class = 'divChangingData' name='divWSSChangeNicknameForm'><p class='nightGhost'>Запишете вашето ново име:</p>
            ...
            <button class='nightBlue btnFine' type='submit' name='ChangeNicknameP' value='ChangeNicknameP'>Потвърди</button>	
        </form></div>";
}
    ...
    if ($stmt48->rowCount() > 0) {
        while ($row = $stmt48->fetch(PDO::FETCH_ASSOC)) {
            ...
            if ($stmt52) {
                ...
                echo "<p class = 'nightGhost Zapisi'>Вашeто ново име е </p></div>" . $Newname;
            } else {
                echo '';
				}
        }
...
if (isset($_POST['ChangePassword'])) {
    echo "<div class = 'divChangingData' name='divWSSChangePasswordForm'><p class='nightGhost'>Запишете вашата нова парола:</p>
            ...
            <button class='nightBlue btnFine' type='submit' name='ChangePasswordP' value='ChangePasswordP'>Потвърди</button>	
        </form></div>";
}
...
if (isset($_POST['ChangePasswordP'])) {
    ...
    if ($stmt55->rowCount() > 0) {
        ...
        if ($stmt58) {
            ...
            echo "<p class = 'nightGhost Zapisi'>Вашата нова парола е </p>" . $Newpass;
        } else {
            echo ' ';
			}
    } else {
...
if (isset($_POST['ChangeNameAndPass'])) {
    echo "<div class = 'divChangingData' name='divWSSChangeNameAndPassForm'>
			...
			<p id='idNick' class='nightGhost'>Запишете вашето ново име: <input type='text' name='Newname' value=''></p><br>
			<p id='idPass' class='nightGhost'>Запишете вашата нова парола: <input type='text' name='Newpass' value=''></p><br><br>
			<button class='nightBlue' type='submit' name='ChangeNameAndPass2' value='ChangeNameAndPass2'>Потвърди</button>	
		</form>
	</div>";
}
...
if (isset($_POST['ChangeNameAndPass2'])) {
    ...
    if ($stmt60->rowCount() > 0) {
        ...
        if ($stmt64) {
            $_SESSION['SSName'] = $Newname;
            $_SESSION['SSPassword'] = $Newpass;
            echo '<p class = "nightGhost Zapisi">Вашата нова парола е </p>' . $Newpass . $Newname;
        } else {
            echo ' ';
			}
    } else {
...
if (isset($_POST['DelPersonData'])) {
    echo "<div class = 'divChangingData' name='divWSSDelPersonDataForm'><p class='nightGhost'>Сигурен ли сте, че искате да изтриете Вашите данни и да не влизате в Secret Santa?</p>";
    echo "<form action='WishesSecretSanta.php' target='_self' method='post' name='WSSDelPersonDataForm' accept-charset='utf-8'>
            <button class='nightBlue' type='submit' name='DelPersonDataP' value='DelPersonDataP'>Да</button>
            <button class='nightBlue' type='submit' name='DelPersonDataB' value='DelPersonDataB'>Не</button>	
        </form></div>";
}
...
if (isset($_POST['DelPersonDataP'])) {
    ...
    if ($stmt68->rowCount() > 0) {
        ...
        $stmt71->execute();
        if ($stmt70) {
            echo "<script> setInterval(ExitPerson,3000); </script>";
        } else {
            echo ' ';
			}
    } else {
...
if (isset($_POST['DelPersonDataB'])) {
    echo "<div class = 'divChangingData' name='divDelPersonData'><p class='nightGhost'>Здравей, Secret Santa!<br>Отново!</p></div>";
} else {
    echo '';
	}
...
if (isset($_POST['AdminConnectButton'])) {
    ...
    try {
        ...
        $stmt2->execute();
        echo "<div class = 'divShowData' name='divExit'><p class='nightGhost'>Изпратено съобщение!</p></div>";
    }
    catch (PDOException $e) {
        echo " " . $e->getMessage();
		}
...
if(isset($_POST['ExitSait'])){
	...
	session_unset();
	session_destroy();	
	echo "<script> setInterval(ExitPerson,1000); </script>";
}
?>
...
<?php 
//DELETE FROM persons WHERE email IN .... SELECT email FROM persons GROUP BY email HAVING "";
